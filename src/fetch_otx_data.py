...
if __name__ == "__main__":
    # Use the provided API key from environment variable
    api_key = os.getenv("ALIENVAULT_OTX_API_KEY", "20605e2bc55efa3fbcc3251c289a8002553a3e7766ac92fbfe60b3053b2025e1")
